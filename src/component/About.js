    ...
    <div>
      <main style={{ backgroundColor: "#aaeba7" }}>
        <section className="about-section">
          ...
          <p>
            Our platform is designed to offer a seamless experience, connecting
          ...
          <p>
            Moreover, we believe in empowering property owners by offering a
            ...
            available for rent has never been easier.
          </p>
        </section>
      </main>
      <h2>About Us</h2>
